...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.key_units_pref),
                mContext.getString(R.string.metric_units_pref));

        if (unitType.equals(mContext.getString(R.string.imperial_units_pref))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.metric_units_pref))) {
